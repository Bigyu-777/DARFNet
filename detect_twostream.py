...
if __name__ == '__main__':
    ...
    parser.add_argument('--source1', type=str, default=r'D:\worksapce\multispectral-object-detection-main\Dronevehicle\val\valimg\images', help='source')  # file/folder, 0 for webcam
    parser.add_argument('--source2', type=str, default=r'D:\worksapce\multispectral-object-detection-main\Dronevehicle\val\valimgr\images', help='source')  # file/folder, 0 for webcam
